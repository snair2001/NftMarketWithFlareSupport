import type { BIP44Depth, Network, PartialHDPathTuple, RootedSLIP10PathTuple, RootedSLIP10SeedPathTuple } from "./constants.cjs";
...
export declare class BIP44Node implements BIP44NodeInterface {
     ...
     */
    static fromSeed({ derivationPath, network }: BIP44SeedOptions, cryptographicFunctions?: CryptographicFunctions): Promise<BIP44Node>;
