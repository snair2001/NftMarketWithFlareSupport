...
import { isValidBytesKey, numberToUint32, validateBytes } from "../utils.mjs";
/**
 ...
 */
export async function deriveSecretExtension({ privateKey, publicKey, childIndex, isHardened, curve, }) {
    if (isHardened) {
        // Hardened child
        return concatBytes([
            new Uint8Array([0]),
