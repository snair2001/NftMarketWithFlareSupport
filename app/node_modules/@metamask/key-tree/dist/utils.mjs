...
import { BIP_44_COIN_TYPE_DEPTH } from "./BIP44CoinTypeNode.mjs";
 ...
 */
export function validateBytes(bytes, length) {
 ...
 */
export function getBIP44CoinType(derivationPath) {
    ...
    assert(isValidInteger(value), 'Invalid derivation path: Coin type is not a valid integer.');
    return value;
}
