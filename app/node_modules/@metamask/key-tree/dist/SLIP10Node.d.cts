...
import { PUBLIC_KEY_GUARD } from "./guard.cjs";
/**
...
type SLIP10NodePrivateKeyConstructorOptions = BaseSLIP10NodeConstructorOptions & {
    readonly privateKey: Uint8Array;
    readonly publicKey?: Uint8Array | undefined;
};
type SLIP10NodePublicKeyConstructorOptions = BaseSLIP10NodeConstructorOptions & {
    readonly privateKey?: Uint8Array | undefined;
    readonly publicKey: Uint8Array;
};
export type SLIP10NodeConstructorOptions = SLIP10NodePrivateKeyConstructorOptions | SLIP10NodePublicKeyConstructorOptions;
...
export declare class SLIP10Node implements SLIP10NodeInterface {
     ...
     * @returns A new SLIP-10 node.
     */
    static fromSeed({ derivationPath, network, curve }: SLIP10DerivationPathOptions, cryptographicFunctions?: CryptographicFunctions): Promise<SLIP10Node>;
    readonly curve: SupportedCurve;
    readonly depth: number;
    readonly masterFingerprint?: number | undefined;
    readonly parentFingerprint: number;
