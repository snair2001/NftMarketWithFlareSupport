import type { CoinTypeHDPathTuple, CoinTypeSeedPathTuple } from "./BIP44CoinTypeNode.cjs";
 ...
 */
export declare function validateBytes(bytes: Uint8Array, length: number): asserts bytes is Uint8Array;
 ...
 */
export declare function getBIP44CoinType(derivationPath: CoinTypeHDPathTuple | CoinTypeSeedPathTuple): number;
export {};
