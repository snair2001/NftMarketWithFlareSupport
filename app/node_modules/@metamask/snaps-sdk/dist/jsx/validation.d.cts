 ...
 */
export declare const FieldChildUnionStruct: Struct<SnapElement<import("./components/index.cjs").AssetSelectorProps, "AssetSelector"> | SnapElement<import("./components/index.cjs").AddressInputProps, "AddressInput"> | SnapElement<import("./components/index.cjs").IconProps, "Icon"> | SnapElement<{
    src: string;
 ...
 */
export declare const BoxChildStruct: Struct<SnapElement<import("./components/index.cjs").AssetSelectorProps, "AssetSelector"> | SnapElement<import("./components/index.cjs").AddressInputProps, "AddressInput"> | SnapElement<import("./components/index.cjs").IconProps, "Icon"> | SnapElement<{
    src: string;
    alt?: string | undefined;
    borderRadius?: import("./components/index.cjs").BorderRadius;
}, "Image"> | SnapElement<import("./components/index.cjs").ButtonProps, "Button"> | SnapElement<import("./components/index.cjs").CheckboxProps, "Checkbox"> | SnapElement<import("./components/index.cjs").FormProps, "Form"> | SnapElement<import("./components/index.cjs").InputProps, "Input"> | SnapElement<import("./components/index.cjs").DropdownProps, "Dropdown"> | SnapElement<{
 ...
 */
export declare const RootJSXElementStruct: Struct<SnapElement<import("./components/index.cjs").AssetSelectorProps, "AssetSelector"> | SnapElement<import("./components/index.cjs").AddressInputProps, "AddressInput"> | SnapElement<import("./components/index.cjs").IconProps, "Icon"> | SnapElement<{
    src: string;
    alt?: string | undefined;
    borderRadius?: import("./components/index.cjs").BorderRadius;
}, "Image"> | SnapElement<import("./components/index.cjs").ButtonProps, "Button"> | SnapElement<import("./components/index.cjs").CheckboxProps, "Checkbox"> | SnapElement<import("./components/index.cjs").FormProps, "Form"> | SnapElement<import("./components/index.cjs").InputProps, "Input"> | SnapElement<import("./components/index.cjs").DropdownProps, "Dropdown"> | SnapElement<{
